...
import com.example.theconsciousness.databinding.ActivityMyBlogBinding
...
class MyBlogActivity : AppCompatActivity() {
    private lateinit var binding: ActivityMyBlogBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMyBlogBinding.inflate(layoutInflater)
        ...
        blogList=ArrayList()
        adapter= BlogAdapter(this, blogList!!)
